...
export default function VisibilidadeSegurancaPage() {
  // UI state
  ...
  const solutions = [
    {
      name: "Netscout",
      tagline: "Monitoramento e análise de redes e aplicativos",
      description: [
        "Soluções especializadas em monitoramento e análise de redes e aplicativos. Garanta a integridade e o desempenho em ambientes complexos como data centers, nuvens e redes corporativas com visibilidade em tempo real e segurança avançada.",
      ],
      features: [
    ...
    {
      name: "OLT Cloud",
      tagline: "Gerenciamento remoto de redes GPON",
      description: [
        "Gerenciamento remoto de redes GPON via nuvem. Monitore fibras ópticas, identifique falhas e congestionamentos, e gerencie ONUs/ONTs com alertas em tempo real, KPIs detalhados e mapas interativos.",
      ],
      features: [
        "Monitoramento em tempo real",
        "Alertas e KPIs detalhados",
        "Mapas interativos",
        "Gerenciamento de ONUs/ONTs",
      ],
      image: "/olt-cloud.png",
    ...
    {
      name: "Aviz Networks",
      tagline: "Automação e otimização com IA",
      description: [
        "Automação e otimização de redes com inteligência artificial. Ideal para redes desagregadas e SONiC, oferece insights preditivos, respostas rápidas e eficiência escalável para uma experiência de rede resiliente.",
      ],
      features: ["Insights preditivos", "Respostas rápidas", "Eficiência escalável", "Suporte a SONiC"],
      image: "/aviz-networks.png",
      ...
      <main className="flex-1 pt-16">
        ...
        <section className="bg-[#1a0b2e] text-white">
          <div className="container mx-auto px-4 py-16 md:py-24 lg:py-32">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              ...
              >
                <div className="inline-block mb-4 px-3 py-1 bg-orange-700 rounded-sm text-sm font-medium">
                  Visibilidade e Segurança
                </div>
                <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6 leading-tight">
                  Soluções de Visibilidade e Segurança para Redes de Alto Desempenho
                </h1>
                <p className="text-lg md:text-xl mb-6 text-white/90">
                  Monitore, gerencie e otimize suas redes com ferramentas avançadas
                </p>
                <p className="text-white/80 mb-8">
                  Garanta segurança e eficiência – da nuvem ao data center – com tecnologias líderes de mercado.
                </p>
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                  <Button className="bg-orange-700 hover:bg-orange-800 text-white px-6 py-2.5">
                    Conhecer soluções
              ...
              >
                <div className="relative rounded-md overflow-hidden">
                  <Image
                    src="/network-dashboard.jpg"
                    alt="Dashboard de rede"
                    width={600}
                    height={400}
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div>
                <div className="inline-block mb-4 px-3 py-1 bg-orange-100 text-orange-800 rounded-sm text-sm font-medium">
                  Tecnologia de Ponta
                </div>
                <h2 className="text-2xl md:text-3xl font-bold mb-6 text-gray-900">
                  Transforme Sua Infraestrutura de TI
                </h2>
                <p className="text-gray-700 mb-6">
                  Nossas soluções de visibilidade e segurança oferecem ferramentas avançadas para monitoramento,
                  gerenciamento e otimização de redes, garantindo que sua empresa esteja preparada para os desafios do
                  mercado digital.
                </p>
                <p className="text-gray-700 mb-8">
                  Com tecnologias como Netscout, OLT Cloud e Aviz Networks, você terá visibilidade total, automação
                  inteligente e segurança robusta para redes corporativas, fibra óptica e ambientes desagregados.
                </p>
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            ...
            >
              <h2 className="text-2xl md:text-3xl font-bold mb-4 text-gray-900">Resultados Que Fazem a Diferença</h2>
              <p className="text-gray-600 max-w-3xl mx-auto">
                Nossas soluções oferecem benefícios tangíveis para sua infraestrutura de rede
              </p>
            </motion.div>
              ...
              {[
                {
                  ...
                  description: "Veja e controle cada detalhe da sua rede, onde quer que ela esteja.",
                  icon: <Eye className="h-6 w-6" />,
                },
                {
                  title: "Resolução Rápida",
                  description: "Identifique e solucione problemas antes que impactem seus clientes.",
                  icon: <Zap className="h-6 w-6" />,
                },
                {
                  title: "Automação Inteligente",
                  description: "Deixe a IA trabalhar por você, reduzindo esforço e aumentando eficiência.",
                  icon: <BarChart3 className="h-6 w-6" />,
                },
                {
                  title: "Escalabilidade",
                  description: "Prepare sua infraestrutura para crescer sem complicações.",
                ...
                >
                  <div className="text-orange-700 mb-4">{feature.icon}</div>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-2xl md:text-3xl font-bold mb-4 text-gray-900">Conheça nossas soluções</h2>
              <p className="text-gray-600 max-w-3xl mx-auto">
                Descubra como Netscout, OLT Cloud e Aviz Networks podem elevar o nível da sua infraestrutura de TI
              </p>
            </div>

            <div className="mb-8">
              <div className="flex justify-between items-center mb-6">
                <h3 className="text-xl font-bold text-gray-900">Nossas Soluções</h3>
                    ...
                    <div className="p-6 grid md:grid-cols-2 gap-6">
                      <div>
                        ...
                        <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }}>
                          <Button className="w-full bg-orange-700 hover:bg-orange-800 text-white rounded-sm">
                ...
                {solutions.map((_, index) => (
                  <button
                    ...
                    className={`w-2.5 h-2.5 rounded-full transition-all ${
                      index === activeProduct ? "bg-orange-700" : "bg-gray-300 hover:bg-gray-400"
                    }`}
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div>
                  ...
                  <p className="text-white/80 mb-6">
                    ...
                    infraestrutura de rede. Entre em contato para uma consultoria personalizada.
                  </p>
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-2xl md:text-3xl font-bold mb-4 text-gray-900">Por Que Escolher Nossas Soluções?</h2>
              <p className="text-gray-600 max-w-3xl mx-auto">
                Com tecnologias líderes como Netscout, OLT Cloud e Aviz Networks, oferecemos visibilidade total,
                automação inteligente e gerenciamento simplificado
              </p>
            </div>
              ...
              {[
                {
                  ...
                  description:
                    "Utilizamos ferramentas avançadas para garantir visibilidade e segurança de alto nível em sua rede.",
                  icon: <Lightbulb className="h-6 w-6" />,
                },
                {
                  title: "Suporte Especializado",
                  description:
                    "Nossa equipe está pronta para oferecer suporte técnico e consultoria personalizada para suas necessidades.",
                  icon: <Network className="h-6 w-6" />,
                },
                {
                  title: "Soluções Escaláveis",
                  description: "Prepare sua infraestrutura para crescer com soluções que se adaptam ao seu negócio.",
                  icon: <Shield className="h-6 w-6" />,
                },
              ].map((reason, index) => (
                <div key={index} className="bg-white p-6 rounded-md shadow-sm border border-gray-200">
                  <div className="text-orange-700 mb-4">{reason.icon}</div>
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <Button className="bg-orange-700 hover:bg-orange-800 text-white">Saiba mais sobre a VTelco</Button>
              </div>
            ...
            <div className="max-w-3xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="text-2xl md:text-3xl font-bold mb-4 text-gray-900">
                  Pronto para Elevar o Nível da Sua Rede?
                </h2>
                <p className="text-gray-600">
                  Não deixe a falta de visibilidade ou falhas inesperadas comprometerem seu negócio. Experimente nossas
                  soluções com uma demonstração gratuita.
                </p>
              </div>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 max-w-3xl mx-auto">
                Somos especialistas em soluções de visibilidade e segurança, trazendo o poder da Netscout, OLT Cloud e
                Aviz Networks para empresas que buscam redes mais fortes e confiáveis
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-white p-6 rounded-md shadow-sm border border-gray-200">
                <h3 className="text-lg font-bold mb-4 text-gray-900 flex items-center">
                  <MapPin className="mr-2 h-5 w-5 text-orange-700" />
                  Matriz Brasil
                </h3>
                <ul className="space-y-3 text-gray-700">
                  <li className="flex items-start gap-3">
                    <Phone className="h-5 w-5 text-orange-700 mt-0.5 flex-shrink-0" />
                    <span>+55 (41) 99988-9681</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <Mail className="h-5 w-5 text-orange-700 mt-0.5 flex-shrink-0" />
