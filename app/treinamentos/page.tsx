      ...
      <main className="flex-1 pt-16">
        ...
        <section className="bg-[#1a0b2e] text-white">
          <div className="container mx-auto px-4 py-16 md:py-24 lg:py-32">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              ...
              >
                <div className="inline-block mb-4 px-3 py-1 bg-green-700 rounded-sm text-sm font-medium">
                  Treinamentos Especializados
                </div>
                <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6 leading-tight">
                  Capacite sua equipe com conhecimentos especializados em redes
                </h1>
                <p className="text-lg md:text-xl mb-6 text-white/90">
                  Treinamentos práticos e teóricos para profissionais de TI
                </p>
                <p className="text-white/80 mb-8">
                  A VTelco oferece programas de treinamento completos para capacitar sua equipe com as mais recentes
                  tecnologias e melhores práticas em redes.
                </p>
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                  <Button className="bg-green-700 hover:bg-green-800 text-white px-6 py-2.5">
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            ...
            >
              <h2 className="text-2xl md:text-3xl font-bold mb-4 text-gray-900">Benefícios dos Nossos Treinamentos</h2>
              <p className="text-gray-600 max-w-3xl mx-auto">
                Invista no desenvolvimento da sua equipe e colha os resultados
              </p>
            </motion.div>
              ...
              {[
                {
                  ...
                  description: "Treinamentos hands-on com equipamentos reais para experiência prática.",
                  icon: <Lightbulb className="h-6 w-6" />,
                },
                {
                  title: "Instrutores Experientes",
                  description: "Profissionais com vasta experiência no mercado e certificações.",
                  icon: <Network className="h-6 w-6" />,
                },
                {
                  title: "Conteúdo Atualizado",
                  description: "Material didático sempre atualizado com as últimas tecnologias.",
                  icon: <BarChart3 className="h-6 w-6" />,
                },
                {
                  title: "Certificação Reconhecida",
                  description: "Certificados reconhecidos pelo mercado para impulsionar carreiras.",
